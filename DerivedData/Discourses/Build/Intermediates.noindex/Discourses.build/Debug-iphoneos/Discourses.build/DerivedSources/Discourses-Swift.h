...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Discourses",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10Discourses11AppDelegate")
...
SWIFT_CLASS("_TtC10Discourses24KeyboardLayoutConstraint") SWIFT_AVAILABILITY(tvos,unavailable)
...
SWIFT_CLASS("_TtC10Discourses19ReceivedMessageCell")
...
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified messageBackground;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified senderText;
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Null_unspecified stackTopConstraint;
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Null_unspecified stackBottomConstraint;
- (void)awakeFromNib;
- (void)setSelected:(BOOL)selected animated:(BOOL)animated;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC10Discourses13SceneDelegate")
...
SWIFT_CLASS("_TtC10Discourses15SentMessageCell")
...
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified leftBuffer;
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Null_unspecified stackBottomConstraint;
- (void)awakeFromNib;
- (void)setSelected:(BOOL)selected animated:(BOOL)animated;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified myCoursesLabel;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified addChatButton;
...
@interface SubscribedClassesViewController (SWIFT_EXTENSION(Discourses)) <UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end
